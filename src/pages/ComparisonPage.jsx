...
const competitorData = {
  redox: {
    ...
    features: [
      ...
      { feature: 'Clinical NLP & Concept Extraction', vorro: true, them: false },
  ...
  mulesoft: {
    ...
    features: [
      ...
      { feature: 'Clinical NLP', vorro: true, them: false },
  ...
  datavant: {
    ...
    features: [
      ...
      { feature: 'Clinical NLP & Structuring', vorro: true, them: false },
