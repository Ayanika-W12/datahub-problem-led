...
const solutions = {
  ...
  'system-integrations': {
    ...
    headline: 'Connect Any Enterprise System.\nBidirectionally.',
    sub: 'Vorro connects every application in your technology stack — ERPs, CRMs, SaaS platforms, legacy databases, and custom systems — with prebuilt, standards-compliant connectors that go live in days, not months. No rip-and-replace. No bespoke middleware.',
    color: 'primary',
    stats: [
      { val: '200+', label: 'Pre-built system connectors' },
      { val: '2–4 wks', label: 'Avg. time to go live' },
      { val: '100%', label: 'Bidirectional data flow' },
      { val: '0', label: 'Rip-and-replace required' },
    ],
    features: [
      { icon: '⬡', title: 'ERP & CRM Native', desc: 'Salesforce, SAP, Oracle, HubSpot, and NetSuite — certified connectors with field-level mapping and change detection.' },
      { icon: '↔', title: 'Bidirectional Flows', desc: 'Read and write back to any system. REST, SOAP, GraphQL, EDI, flat file — all protocols, all directions.' },
      { icon: '◆', title: 'Real-Time & Batch', desc: 'Stream live events or run scheduled batch extracts. Both modes, one platform, zero duplication.' },
      { icon: '◈', title: 'Schema Translation', desc: 'Automated field mapping and transformation templates across every major data model — JSON, XML, CSV, Parquet.' },
      { icon: '◉', title: 'Legacy & On-Premise', desc: 'JDBC, ODBC, SFTP, AS2, and IBM MQ — we\'ve built the adapters so your old systems become first-class citizens.' },
      { icon: '✦', title: 'Error Routing', desc: 'Every failed message is caught, logged, alerted, and routed to a resolution queue — never silently dropped.' },
    ],
    howItWorks: [
      { num: '01', title: 'Discover', desc: 'Map your current system landscape, data volumes, and integration requirements with our onboarding team.' },
      { num: '02', title: 'Configure', desc: 'Select pre-built connectors and configure transformations using our visual mapping interface — no code required.' },
      { num: '03', title: 'Test', desc: 'Run against real data samples in a sandboxed environment with full validation and regression reporting.' },
      { num: '04', title: 'Go Live', desc: 'Deploy to production with real-time monitoring, alerting, and SLA tracking from day one.' },
    ],
    vendors: ['Salesforce', 'SAP', 'Oracle ERP', 'Microsoft Dynamics', 'HubSpot', 'NetSuite', 'Workday', 'ServiceNow', 'Zendesk', 'Snowflake'],
    flowSources: ['ERP Systems', 'CRM Platforms', 'SaaS Apps', 'Legacy DBs'],
    flowTargets: ['Data Lake', 'Analytics', 'Downstream Apps', 'Reporting'],
  },
  'network-integrations': {
    title: 'Network Integrations',
    headline: 'Multi-Party Data Exchange.\nAt Any Scale.',
    sub: 'Vorro powers network-wide data exchange across partners, regulators, and industry networks — from supplier ecosystems to financial clearing networks to cross-organization data lakes. Clean data in, clean data out, with governance built for every participant.',
    color: 'cyan',
    stats: [
      { val: '50+', label: 'Active network deployments' },
      { val: '10,000+', label: 'Connected endpoints' },
      { val: 'Real-time', label: 'Data exchange speed' },
      { val: '99.9%', label: 'Network uptime SLA' },
    ],
    features: [
      { icon: '◈', title: 'Hub-and-Spoke Architecture', desc: 'Central broker model for multi-party exchanges — one connection point, every participant, full governance.' },
      { icon: '⬡', title: 'Industry Standard Protocols', desc: 'AS2, AS4, SFTP, FTPS, REST, SOAP, EDI X12, EDIFACT — every protocol your network uses, fully supported.' },
      { icon: '↔', title: 'Partner Onboarding', desc: 'Streamlined onboarding for new network participants with templated connection packages and sandbox testing.' },
      { icon: '◉', title: 'Consent & Access Control', desc: 'Per-participant access policies, data sharing agreements, and RBAC — enforced at every exchange point.' },
      { icon: '✦', title: 'Network Health Monitoring', desc: 'Real-time dashboards showing message flow, participant status, SLA adherence, and exception queues.' },
      { icon: '◆', title: 'Regulatory Reporting', desc: 'Automated network-level reporting exports for regulatory submissions, audits, and governance reviews.' },
    ],
    howItWorks: [
      { num: '01', title: 'Onboard Participants', desc: 'Streamlined participant onboarding with pre-built connection templates and sandbox environments.' },
      { num: '02', title: 'Route Messages', desc: 'Smart message routing based on participant, message type, payload content, and data sharing policy.' },
      { num: '03', title: 'Normalize Data', desc: 'Common data model normalization and terminology mapping across all incoming streams.' },
      { num: '04', title: 'Monitor & Report', desc: 'Real-time network health dashboards and automated regulatory reporting exports.' },
    ],
    vendors: ['AS2 Gateways', 'EDI Clearinghouses', 'MuleSoft', 'Dell Boomi', 'Rhapsody', 'Mirth Connect', 'Azure Service Bus', 'AWS EventBridge'],
    flowSources: ['Partners', 'Suppliers', 'Regulators', 'Public APIs'],
    flowTargets: ['Network Hub', 'Data Lake', 'Downstream Systems', 'Reporting'],
  },
  'partner-integrations': {
    title: 'Partner Integrations',
    headline: 'B2B Data Flows.\nClaims & Reconciliation.',
    sub: "Vorro automates the full B2B data loop between you and your partners — vendors, distributors, clients, and third-party platforms — reducing manual reconciliation by up to 70% and ensuring every data exchange is accurate, timely, and auditable.",
    color: 'navy',
    stats: [
      { val: '70%', label: 'Reduction in manual reconciliation' },
      { val: '500+', label: 'Partner connections managed' },
      { val: '<24 hrs', label: 'Typical partner onboarding' },
      { val: '4', label: 'Exchange protocols supported' },
    ],
    features: [
      { icon: '◆', title: 'EDI Automation', desc: 'Full EDI X12 and EDIFACT stack — purchase orders, invoices, ASN, remittance, and acknowledgements — fully automated.' },
      { icon: '◈', title: 'Partner Portal', desc: 'Self-service portal for partners to monitor their data flows, review exceptions, and download reports.' },
      { icon: '↔', title: 'Reconciliation Engine', desc: 'Automated three-way matching across orders, shipments, and invoices — with exception routing and audit trail.' },
      { icon: '⬡', title: 'API-First B2B', desc: 'REST and webhook-based integrations for modern partners — side-by-side with EDI for legacy partners.' },
      { icon: '◉', title: 'Compliance Tracking', desc: 'Track partner SLA adherence, data quality scores, and compliance status across every relationship.' },
      { icon: '✦', title: 'Dispute Management', desc: 'Structured workflows for data discrepancies with full audit trail and resolution tracking.' },
    ],
    howItWorks: [
      { num: '01', title: 'Connect', desc: 'API or EDI-based connection to partner systems, clearinghouses, and portals.' },
      { num: '02', title: 'Automate', desc: 'Configure exchange rules, matching logic, and reconciliation workflows — no code required.' },
      { num: '03', title: 'Reconcile', desc: 'Automated three-way matching with exception queues and resolution workflows.' },
      { num: '04', title: 'Report', desc: 'Partner scorecards, SLA tracking, and audit-ready reporting — always current.' },
    ],
    vendors: ['SAP Ariba', 'Coupa', 'Tradeshift', 'TrueCommerce', 'SPS Commerce', 'DiCentral', 'OpenText', 'IBM Sterling'],
    flowSources: ['Partner APIs', 'EDI Feeds', 'FTP / SFTP', 'Portal Uploads'],
    flowTargets: ['ERP', 'Finance', 'Reconciliation', 'Compliance'],
  },
  'specialized-integrations': {
    title: 'Specialized Integrations',
    headline: 'Domain-Specific Data.\nConnectors for Any Vertical.',
    sub: "Not every integration is generic. Vorro's library of specialized connectors covers the domain-specific protocols, formats, and compliance requirements that off-the-shelf tools don't support — from financial data feeds to industry registries to proprietary vendor APIs.",
    color: 'green',
    stats: [
      { val: '300+', label: 'Specialized connector library' },
      { val: '15+', label: 'Industry verticals covered' },
      { val: 'Custom', label: 'Connector SDK available' },
      { val: '100%', label: 'Compliance-aware pipelines' },
    ],
    features: [
      { icon: '◆', title: 'Financial Data Connectors', desc: 'Bloomberg, Reuters Eikon, Plaid, Stripe, and FIX protocol — market data, payments, and banking APIs unified.' },
      { icon: '◈', title: 'Industry Registry Access', desc: 'Automated reads and writes to industry-specific registries, directories, and compliance databases.' },
      { icon: '↔', title: 'IoT & Device Data', desc: 'MQTT, OPC-UA, and industrial protocol support for device telemetry, sensor data, and edge computing integration.' },
      { icon: '⬡', title: 'Proprietary Vendor APIs', desc: 'Pre-built adapters for domain-specific SaaS platforms — we\'ve built the connectors so you don\'t have to.' },
      { icon: '◉', title: 'Compliance Pipelines', desc: 'SOX, GDPR, CCPA, HIPAA, and industry-specific compliance requirements built into every connector.' },
      { icon: '✦', title: 'Custom Connector SDK', desc: 'Build your own connectors using our SDK — full test tooling, documentation, and certification process included.' },
    ],
    howItWorks: [
      { num: '01', title: 'Identify', desc: 'Work with our solutions team to identify your specialized data sources, formats, and compliance requirements.' },
      { num: '02', title: 'Select or Build', desc: 'Choose from our library of 300+ specialized connectors or build custom adapters using our SDK.' },
      { num: '03', title: 'Validate', desc: 'Test against real domain-specific data with full compliance validation and certification.' },
      { num: '04', title: 'Deploy', desc: 'Go live with full monitoring, SLA tracking, and compliance reporting from day one.' },
    ],
    vendors: ['Bloomberg', 'Plaid', 'Stripe', 'Twilio', 'MQTT Brokers', 'OPC-UA', 'Workato', 'Zapier Enterprise'],
    flowSources: ['Industry Feeds', 'IoT Devices', 'Registries', 'Vendor APIs'],
    flowTargets: ['Data Lake', 'Analytics', 'Compliance', 'Downstream Apps'],
  },
  'data-quality': {
    title: 'Data Quality',
    headline: 'Clean Data.\nBetter Outcomes.',
